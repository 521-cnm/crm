...
<script type="text/javascript">
	...
	$(function(){
		...
		var create_by         =$.trim($("#create-create_by").val());
		var create_time       =$.trim($("#create-create_time").val());
		var description       =$.trim($("#create-description").val());
		var contact_summary   =$.trim($("#create-contact_summary").val());
		var next_contact_time =$.trim($("#create-next_contact_time").val());
			...
			<div style="position: relative;top: 50px;">
				<table class="table table-hover">
					...
					<tbody>
						<tr>
							<td><input type="checkbox" /></td>
							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='detailClue?id=35b77448ed684581ad6a91db81fecbf9';">张三教授</a></td>
							<td>动力节点</td>
							<td>010-84846003</td>
							<td>12345678901</td>
							<td>广告</td>
