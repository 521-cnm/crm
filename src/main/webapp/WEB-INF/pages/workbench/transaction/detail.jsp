...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		<c:forEach items="${stageList}" var="stage">
			<%----如果stage就是交易所处阶段，则图标显示为--map-marker，颜色为绿色--%>
			<c:if test="${tran.stage==stage.value}">
				...
				<%--如果stage处在当前交易所处阶段前边，则图标显示为ok-circle，颜色为绿色--%>
		...
		<c:forEach items="${remarkList}" var="remark">
			<div class="remarkDiv" id="div_${remark.id}" style="height: 60px;">
				...
				<div style="position: relative; top: -40px; left: 40px;" >
					...
					<font color="gray">交易</font> <font color="gray">-</font> <b>${remark.name}</b> <small style="color: gray;"> ${remark.editFlag=='0'?remark.createTime:remark.editTime} 由${remark.editFlag=='0'?remark.createBy:remark.editBy}${remark.editFlag=='0'?'创建':'修改'}</small>
