...
<body>
	...
	<form class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="hidden" id="create-activityId" value="054a53db96ad437ab66bfef087ff100f">
				<input type="text" class="form-control" id="create-activityName" value="05">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="hidden" id="create-contactsId" value="e9ea5879e01546d2bf3181599e6d05bd">
