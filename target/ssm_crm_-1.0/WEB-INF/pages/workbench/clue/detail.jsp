...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#searchActivityTxt").keyup(function () {
			...
			var clueId='${clue.id}';
			$.ajax({
				url:'queryActivityForDetailByNameClueId',
				data:{
		...
		$("#convertClueBtn").click(function () {
			...
			var id='${clue.id}';
			//发送同步请求
			window.location.href="toConvert?id="+id;
		});
	...
	<div style="position: relative; top: 40px; left: 40px;">
		...
		<c:forEach items="${remarkList}" var="remark">
			<div class="remarkDiv" id="div_${remark.id}" style="height: 60px;">
				...
				<div style="position: relative; top: -40px; left: 40px;" >
					<h5>哎呦！</h5>
					<font color="gray">线索</font> <font color="gray">-</font> <b>${clue.fullname}${clue.appellation}-${clue.company}</b> <small style="color: gray;">${remark.editFlag=='0'?remark.createTime:remark.editTime}由${remark.editFlag=='0'?remark.createBy:remark.editTime}${remark.editFlag=='0'?'创建':'修改'}</small>
